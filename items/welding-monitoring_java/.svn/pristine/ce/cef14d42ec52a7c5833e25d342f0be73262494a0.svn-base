package com.vren.weldingmonitoring_java.resolver;
...
import com.vren.weldingmonitoring_java.service.UserOperateLogService;
...
public class OperateLogAspect {
    ...
    @Pointcut("execution(* com.vren.*..*Controller.*(..))")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Throwable e) {
        try {
            ...
            for (Object obj : args) {
                ...
                if (obj instanceof MultipartFile || obj instanceof HttpServletResponse || obj instanceof HttpServletRequest) {
                    continue;
                }
                sb.append("[");
    ...
    private OperateLog getAnnotationLog(JoinPoint joinPoint) throws Exception {
        ...
        if (method != null) {
            OperateLog annotation = AnnotationUtils.findAnnotation(method.getDeclaringClass(), OperateLog.class);
            if (annotation == null) {
